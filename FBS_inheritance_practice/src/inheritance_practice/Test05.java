...
public class Test05 {
	...
	public static void main(String[] args) {
		...
		ElectronicDevice ed;
		ed = new Mobile(100,"mobile","redmi",10000,4,3);
		ed.display();
		System.out.println();
		
		ed = new MusicSystem(200,"music system","sony",5000,200,4);
		ed.display();
		System.out.println();
		
		ed = new TV(300,"television","LG",50000,150,"4K");
		ed.display();
		
//		Mobile m = new Mobile(101,"mobile","redmi",12000,4,3);
//		m.display();
//		
//		MusicSystem ms = new MusicSystem(201,"music system", "sony", 3000, 5, 6);
//		ms.display();
//		
//		TV t1 = new TV(301,"TV","sony",50000,160,"4K");
//		
//		t1.display();
	}
